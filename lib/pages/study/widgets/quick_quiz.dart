...
//                           trailing: Text(
//                             item.date ?? "",
//                             style: TextStyle(color: lightSkyBlue, fontSize: 16,fontWeight:FontWeight.bold),
//                           ),
//                         ),
//                       ),
//                     ),
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      if (item.title == "Question of the Day") {
                        ...
                        final quizQuestions =
                        Get.find<EditeSubjectController>().startQuiz();
                        final isSubscribed =
                            Get.find<RemoveAds>().isSubscribedGet.value;
                        ...
                        final freeUserQuestions =
                        Get.find<EditeSubjectController>().startQuizForFreeUser();
                        Get.to(() => QuizzesView(
                          allQuestion:
